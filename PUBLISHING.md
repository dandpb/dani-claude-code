# Publishing Guide: dani's Claude Code Plugin
...
- [ ] Repository renamed to `dani-claude-code` ✅
...
2. Fill in the details:
   - **Repository name**: `dani-claude-code`
   - **Description**: "dani's personal Claude Code setup with 14 productivity commands and 11 specialized AI agents for modern web development"
...
git remote add origin https://github.com/dandpb/dani-claude-code.git
...
/plugin install dandpb/dani-claude-code
...
```bash
/plugin uninstall dani-claude-code
```

## Step 3: Share Your Plugin

Your README already includes your GitHub username `dandpb`, so users can copy-paste commands directly!
...
```json
{
  ...
  "source": "dandpb/dani-claude-code",
...
GitHub: https://github.com/dandpb/dani-claude-code
```
...
```bash
/plugin update dani-claude-code
```
...
1. Go to your repo: https://github.com/dandpb/dani-claude-code
...
```bash
/plugin install dandpb/dani-claude-code@v1.0.0
```
